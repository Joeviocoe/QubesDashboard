...
class SnapTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const snapMetaDir = _path.join(stageDir.dir, _this.isUseTemplateApp ? "meta" : "snap");
            const args = ["snap", "--app", appOutDir, "--stage", stageDir.dir, "--arch", (0, (_builderUtil || _load_builderUtil()).toLinuxArchString)(arch), "--output", artifactPath, "--docker-image", "electronuserland/builder:latest"];
            ...
            if (_this.isUseTemplateApp) {
                const templateDirName = `snap-template-${(_tools || _load_tools()).SNAP_TEMPLATE_VERSION}`;
                args.push("--template-url", `https://github.com/electron-userland/electron-builder-binaries/releases/download/${templateDirName}/${templateDirName}.7z`, "--template-sha512", (_tools || _load_tools()).SNAP_TEMPLATE_SHA512);
            }
