...
class SnapTarget extends (_core || _load_core()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const args = ["snap", "--app", appOutDir, "--stage", stageDir, "--arch", (0, (_builderUtil || _load_builderUtil()).toLinuxArchString)(arch), "--output", artifactPath, "--docker-image", "electronuserland/builder:latest"];
